...
function renderSecurityPanel() {
  ...
  panel.innerHTML = `
    ...
    <div class="section" style="border-bottom:none">
      ...
      ${otherFindingsHtml}
      ${revokeLink}
      <div style="margin-top:10px;font-size:13px;color:var(--muted);line-height:1.7;cursor:help" data-tip="ZendIQ operates entirely inside your browser. Your wallet private key and seed phrase are never read, stored, or transmitted — they are only ever held inside your wallet extension and are never exposed to ZendIQ. To read your token approvals, your public address (already visible to anyone on-chain) is sent to public Solana RPC providers: PublicNode and Solana Vibe Station. Nothing is sent to any ZendIQ server, and no trade or balance data is shared. revoke.cash is an independent third-party tool — ZendIQ has no affiliation with it and does not share any data with it.">

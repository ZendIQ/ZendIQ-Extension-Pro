  ...
  if (tab?.id) {
    ...
    const hiddenBanner = widgetHidden ? `
      <div style="display:flex;align-items:flex-start;gap:8px;margin-bottom:12px;padding:9px 11px;background:rgba(255,181,71,0.08);border:1px solid rgba(255,181,71,0.28);border-radius:8px;font-size:var(--fs-base);color:#FFB547;line-height:1.55">
        ...
        <span>The ZendIQ widget is <strong style="color:#FFB547">hidden</strong> on <a href="https://jup.ag" target="_blank" rel="noopener" style="color:#FFB547;font-weight:700;text-decoration:underline">jup.ag</a>. Click <button id="mon-widget-enable" style="background:none;border:none;padding:0;font-size:inherit;font-family:inherit;font-weight:700;color:var(--purple);cursor:pointer;text-decoration:underline">Widget</button> above or the toggle to show it again.</span>
      </div>` : '';
    ...
    el.innerHTML = `
      ...
      <div class="monitor-active">
        ...
        <span style="font-size:var(--fs-base);line-height:1.6">
          Trade on <a href="https://jup.ag" target="_blank" rel="noopener" style="color:var(--purple);font-weight:700;text-decoration:none">jup.ag</a> as normal.<br><br>
          ${triggerCopy}<br><br>
    ...
    el.innerHTML = `
      <div class="monitor-inactive">
        ...
        <ol class="monitor-steps">
          <li><div class="ms-num">1</div><span>Open <a href="https://jup.ag" target="_blank" rel="noopener" style="color:var(--purple);font-weight:700;text-decoration:none">jup.ag</a> in this browser</span></li>
          <li><div class="ms-num">2</div><span>Connect your Solana wallet on <a href="https://jup.ag" target="_blank" rel="noopener" style="color:var(--purple);font-weight:700;text-decoration:none">jup.ag</a></span></li>
